...
//--AgentGen END
  ...
  private void createNlmConfigLogEntry(MOFactory moFactory) {
    ...
    nlmConfigLogEntryModel =
      (MOTableModel<NlmConfigLogEntryRow>) moFactory.createTableModel(oidNlmConfigLogEntry,
                                 nlmConfigLogEntryIndex,
  ...
  private void createNlmStatsLogEntry(MOFactory moFactory) {
    ...
    nlmStatsLogEntryModel =
      (MOTableModel<NlmStatsLogEntryRow>) moFactory.createTableModel(oidNlmStatsLogEntry,
                                 nlmStatsLogEntryIndex,
...
,
    ...
    // Table model
    nlmLogEntryModel =
      (MOTableModel<NlmLogEntryRow>) moFactory.createTableModel(oidNlmLogEntry,
                                 nlmLogEntryIndex,
                                 nlmLogEntryColumns);
...
,
    ...
    nlmLogVariableEntryModel =
      (MOTableModel<NlmLogVariableEntryRow>) moFactory.createTableModel(oidNlmLogVariableEntry,
                                 nlmLogVariableEntryIndex,
